...
int mppa_cc_comm_send(int cc_to_io_fd, void *buf, int buf_size){
	...
	mppa_cc_comm_async_send(&cc_to_io_aiocb, cc_to_io_fd, buf, buf_size);
	mppa_cc_comm_async_wait(cc_to_io_aiocb, buf_size);
...
int mppa_cc_comm_receive(int io_to_cc_fd, void *buf, int buf_size){
	...
	mppa_cc_comm_async_receive(&io_to_cc_aiocb, io_to_cc_fd, buf, buf_size);
	mppa_cc_comm_async_wait(io_to_cc_aiocb, buf_size);
